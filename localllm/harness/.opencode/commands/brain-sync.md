---
description: "현재 프로젝트를 영구 지식베이스에 동기화"
---

# /brain-sync — 현재 프로젝트를 영구 지식베이스에 동기화
...
```
/brain-sync                        # 현재 디렉토리 sync
/brain-sync --project-dir <path>   # 특정 디렉토리
```
