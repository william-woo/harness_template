---
description: "스킬 자동 생성 + self-improve + agentskills.io 검증 (claude.hermes 전용)"
---

# /skill-forge — 스킬 자동 생성 + self-improve + agentskills.io 검증 (claude.hermes 전용)
...
- `/learn` 으로 쌓인 학습이 절차적 지식일 때 (`from-learning`)
