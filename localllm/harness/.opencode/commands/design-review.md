...
```
/design-review                                        # downstream 기본 (전체)
/design-review --scope=downstream --target=<경로>    # 특정 파일/디렉토리
/design-review --scope=self                          # 하네스 자체 정합성
/design-review --rerun=BLOCK-IA-6                    # 특정 항목 재검사
```
