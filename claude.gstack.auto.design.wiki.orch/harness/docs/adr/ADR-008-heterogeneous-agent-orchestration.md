...
`Accepted` — F013 3세션 완료. 사용자와의 깊은 논의 결과 (single-host 원칙 + d-1/d-2/d-3 단계 구분 +
...
> **위임**: 실제 리서치 노트 6섹션 형식 (요약 / 핵심 발견 / 옵션 비교 / 다음 에이전트를
> 위한 권장 사항 / 한계 및 미확인 / 직접 호출 가이드) 은 **`.claude/agents/researcher.md`
> 본문을 참조**한다. researcher.md 가 단일 소스이며 이 ADR 의 4섹션 스케치보다 충실하다.
