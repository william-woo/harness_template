...
```
/lint                                    # 전체 검사기 실행
/lint --strict                           # BLOCK 있으면 exit 1 (CI gate)
/lint --only=LINT-FL                     # 특정 검사기만
/lint --only=LINT-FL,LINT-AC             # 복수 지정
/lint --json                             # 머신용 JSON 출력
/lint report                             # 마지막 실행 결과 표시
/lint regenerate-index                   # docs/index.md 갱신
```
